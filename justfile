...
fastclick: 
  ./fastclick/bin/click --dpdk -l 0 -a 0000:00:06.0 --log-level "pmd.net.ice*:debug" -- ./test/fastclick/pktgen-l2.click

fastclick-reflect:
  ./fastclick/bin/click --dpdk -l 0 -a 0000:00:06.0 --log-level "pmd.net.ice*:debug" -- ./test/fastclick/dpdk-bounce.click
