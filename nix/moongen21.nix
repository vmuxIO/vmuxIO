...
let 
  srcpack = {
    ...
    libmoon = fetchFromGitHub {
      owner = "vmuxIO";
      repo = "libmoon";
      rev = "68c1f66b43553e54606f76b75589fc1007e3e7b8"; # dev/ice
      fetchSubmodules = true;
      sha256 = "sha256-NZGVzGlGCKKN+poopNk/5zV/twuci7fNaolnY/aNURs=";
    };
    dpdk = /scratch/okelmann/MoonGen/libmoon/deps/dpdk;
