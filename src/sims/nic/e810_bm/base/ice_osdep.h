...
#endif
#endif
#define ice_min(a, b) RTE_MIN(a, b)
#define ice_max(a, b) RTE_MAX(a, b)
...
#define ice_info(hw, fmt, args, ...) ice_debug(hw, ICE_DBG_ALL, fmt, __VA_ARGS__)
#define ice_warn(hw, fmt, args, ...) ice_debug(hw, ICE_DBG_ALL, fmt, __VA_ARGS__)
